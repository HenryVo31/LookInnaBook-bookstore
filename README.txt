...
- This application uses HTML/CSS and JavaScript for the front-end, and Node.js for the back-end, therefore, you will need to first install Node.js on your local machine
...
- This web application uses PostgreSQL for the back-end SQL Database, therefore, you will need to install PostgreSQL on your local machine
